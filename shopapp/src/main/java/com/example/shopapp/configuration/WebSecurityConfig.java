        ...
        http.csrf(AbstractHttpConfigurer::disable)
            ...
            requests.requestMatchers(
                ...
                .permitAll()
                    ...
                    .requestMatchers(GET, String.format("%s/orders-detail/**", apiPrefix)).hasAnyRole(Role.ADMIN, Role.USER)
                    .requestMatchers(POST, String.format("%s/orders-detail/**", apiPrefix)).hasAnyRole(Role.ADMIN)
                    .requestMatchers(PUT, String.format("%s/orders-detail/**", apiPrefix)).hasRole(Role.ADMIN)
                    .requestMatchers(DELETE, String.format("%s/orders-detail/**", apiPrefix)).hasRole(Role.ADMIN)
